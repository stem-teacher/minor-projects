...
import { KnowledgeGraphManager, Entity, Relation, trace } from './database.js';
      ...
      try {
        ...
        switch (name) {
          ...
          case "delete_entities":
            result = await knowledgeGraphManager.deleteEntities(args?.entityNames as string[]);
            break;
            
          case "delete_observations":
            result = await knowledgeGraphManager.deleteObservations(args?.deletions as { entityName: string; observations: string[] }[]);
            break;
            
          case "delete_relations":
            result = await knowledgeGraphManager.deleteRelations(args?.relations as Relation[]);
            break;
