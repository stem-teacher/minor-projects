...
def generate_introduction():
    ...
    # Create the prompt
    prompt = """Create an introduction chapter for a Stage 5 science textbook following the NSW curriculum. The content should be high-quality, accessible, and engaging for all students.

This introduction should:
1. Welcome students to the study of science at Stage 5 level
