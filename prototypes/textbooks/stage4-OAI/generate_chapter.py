...
def generate_chapter(chapter_num, chapter_title):
    ...
    # Create the prompt
    prompt = f"""Create Chapter {chapter_num}: {chapter_title} for a Stage 4 science textbook following the NSW curriculum. The content should be high-quality, accessible, and engaging for all students.
