...
def fix_chapter_file(file_path):
    ...
    try:
        ...
        # Fix 4: Fix undefined control sequences (often found as "\1")
        content = re.sub(r'\\1', r'% Removed undefined command', content)
        
        # Fix 5: Add FloatBarrier at the end of each section
        content = re.sub(r'(\\section{[^}]*})', r'\\FloatBarrier\n\\1', content)
        
        # Fix 6: Add FloatBarrier at the end of document
