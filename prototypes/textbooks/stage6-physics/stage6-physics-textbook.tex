% Stage 6 Physics Textbook (OpenAI Version)
...
% Introduction
\input{stage6-physics/chapters/introduction}
\FloatBarrier

% Add all chapters here
% They will be uncommented one by one during compilation

% \input{stage6-physics/chapters/chapter1}
% \FloatBarrier

% \input{stage6-physics/chapters/chapter2}
% \FloatBarrier

% \input{stage6-physics/chapters/chapter3}
% \FloatBarrier

% \input{stage6-physics/chapters/chapter4}
% \FloatBarrier

% \input{stage6-physics/chapters/chapter5}
% \FloatBarrier

% \input{stage6-physics/chapters/chapter6}
% \FloatBarrier

% \input{stage6-physics/chapters/chapter7}
% \FloatBarrier

% \input{stage6-physics/chapters/chapter8}
% \FloatBarrier
