% Stage 6 Chemistry Textbook (OpenAI Version)
...
% Introduction
\input{stage6-chemistry/chapters/introduction}
\FloatBarrier

% Add all chapters here
% They will be uncommented one by one during compilation

% \input{stage6-chemistry/chapters/chapter1}
% \FloatBarrier

% \input{stage6-chemistry/chapters/chapter2}
% \FloatBarrier

% \input{stage6-chemistry/chapters/chapter3}
% \FloatBarrier

% \input{stage6-chemistry/chapters/chapter4}
% \FloatBarrier

% \input{stage6-chemistry/chapters/chapter5}
% \FloatBarrier

% \input{stage6-chemistry/chapters/chapter6}
% \FloatBarrier

% \input{stage6-chemistry/chapters/chapter7}
% \FloatBarrier

% \input{stage6-chemistry/chapters/chapter8}
% \FloatBarrier
